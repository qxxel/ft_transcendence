...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/19 16:27:16 by agerbaud          #+#    #+#             */
/*   Updated: 2025/11/19 16:29:55 by agerbaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export class	TankGame {
	...
	constructor(
		...
		const	tankWidth: number = 10;
		const	tankHeight: number = 100;
		const	tankSpeed: number = 6;
